...
```html
<footer>Made with <a href="https://github.com/BullenMoore/ReciPies">ReciPies @currentVersion</a></footer>
```
This example is currently implemented inside *_Layout.cshtml* and renders at the bottom of every page to the right and works out of the box.
So attribution is basically already done if nothing in changed in the code, easy for you and easy for me (:
